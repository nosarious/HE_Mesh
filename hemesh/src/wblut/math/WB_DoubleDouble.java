...
public strictfp final class WB_DoubleDouble implements Serializable,
     ...
     */
    public static WB_DoubleDouble valueOf(final String str)
	    throws NumberFormatException {
	return parse(str);
    }
	...
	final String digitsWithDecimal = digits.charAt(0) + "."
		+ trailingDigits;
	if (this.isNegative()) {
     ...
     *         decimal point
     */
    private String extractSignificantDigits(final boolean insertDecimalPoint,
	    final int[] magnitude) {
     ...
     *             if <tt>str</tt> is not a valid representation of a number
     */
    public static WB_DoubleDouble parse(final String str)
	    throws NumberFormatException {
	int i = 0;
