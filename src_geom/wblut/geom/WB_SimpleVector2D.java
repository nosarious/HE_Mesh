 ...
 *
 */
public class WB_SimpleVector2D implements WB_MutableCoord {
	/** Coordinates. */
	double x, y;
	 ...
	 * @param y
	 */
	public WB_SimpleVector2D(final double x, final double y) {
		this.x = x;
		this.y = y;
	}
	 ...
	 * @param x
	 */
	public WB_SimpleVector2D(final double[] x) {
		if (x.length != 2) {
	 ...
	 * @param toPoint
	 */
	public WB_SimpleVector2D(final double[] fromPoint, final double[] toPoint) {
	 ...
	 * @param v
	 */
	public WB_SimpleVector2D(final WB_Coord v) {
		x = v.xd();
		y = v.yd();
	}
	 ...
	 * @param toPoint
	 */
	public WB_SimpleVector2D(final WB_Coord fromPoint, final WB_Coord toPoint) {
