...
WB_Context2D {
     ...
     * @param offset
     */
    public WB_EmbeddedPlane(final int mode, final double offset) {
	super();
	this.mode = mode;
	this.offset = offset;
	if ((mode < 0) || (mode > 5)) {
     ...
     * @param mode
     */
    public WB_EmbeddedPlane(final int mode) {
	this(mode, 0);
    }
     ...
     * @param P
     */
    public WB_EmbeddedPlane(final WB_Plane P) {
     ...
     * @param offset
     */
    public WB_EmbeddedPlane(final WB_Plane P, final double offset) {
