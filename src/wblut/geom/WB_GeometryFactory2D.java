...
public class WB_GeometryFactory2D {
	 ...
	 *
	 */
	private final WB_Point origin2D;
	/**
	 *
	 */
	private final WB_Vector X2D;
	/**
	 *
	 */
	private final WB_Vector Y2D;

	private final WB_Vector mX2D;
	/**
	 *
	 */
	private final WB_Vector mY2D;
	 ...
	 * @return coordinate
	 */
	public WB_CoordinateSystem createCSFromOX2D(final WB_Coord origin, final WB_Coord X) {
	 ...
	 * @return coordinate system
	 */
	public WB_CoordinateSystem createCSFromOXY2D(final WB_Coord origin, final WB_Coord X, final WB_Coord Y) {
	...
	public WB_Polygon createSimplePolygon(final WB_Polygon poly) {
		return new WB_PolygonTriangulator().makeSimplePolygon(poly);
	}
