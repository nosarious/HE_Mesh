...
public class HEC_IsoSurfaceVOL extends HEC_Creator {
	 ...
	 * @return self
	 */
	public HEC_IsoSurfaceVOL setResolution(final int resx, final int resy, final int resz) {
		this.resx = resx;
		this.resy = resy;
		this.resz = resz;
		return this;
	 ...
	 * @return self
	 */
	public HEC_IsoSurfaceVOL setSize(final double dx, final double dy, final double dz) {
		this.dx = dx;
		this.dy = dy;
		this.dz = dz;
		return this;
	 ...
	 * @return self
	 */
	public HEC_IsoSurfaceVOL setValues(final double[][][] values) {
		this.values = values;
		return this;
	}
	 ...
	 * @return self
	 */
	public HEC_IsoSurfaceVOL setValues(final float[][][] values) {
	 ...
	 * @return self
	 */
	public HEC_IsoSurfaceVOL setBoundary(final double v) {
		boundary = v;
		return this;
	}
	 ...
	 * @return self
	 */
	public HEC_IsoSurfaceVOL clearBoundary() {
		boundary = Double.NaN;
		return this;
	}
	 ...
	 * @return self
	 */
	public HEC_IsoSurfaceVOL setInvert(final boolean invert) {
		this.invert = invert;
		return this;
	}
	 ...
	 */
	@Override
	public HEC_IsoSurfaceVOL setCenter(final WB_Coord c) {
		cx = c.xd();
		cy = c.yd();
		cz = c.zd();
		return this;
	 ...
	 * @return edge vertex
	 */
	private HE_Vertex xedge(final int i, final int j, final int k, final WB_Point offset) {
	 ...
	 * @return edge vertex
	 */
	private HE_Vertex yedge(final int i, final int j, final int k, final WB_Point offset) {
	 ...
	 * @return edge vertex
	 */
	private HE_Vertex zedge(final int i, final int j, final int k, final WB_Point offset) {
	...
	private void getPolygons(final int i, final int j, final int k, final int cubeindex, final WB_Point offset) {
		...
		for (int t = 0; t < numtris; t++) {
			...
			final HE_Vertex v1 = getIsoVertex(indices[currentindex++], i, j, k, offset);
			final HE_Vertex v2 = getIsoVertex(indices[currentindex++], i, j, k, offset);
			final HE_Vertex v3 = getIsoVertex(indices[currentindex++], i, j, k, offset);
