...
public class HEC_Beethoven extends HEC_Creator {
	...
	protected HE_Mesh createBase() {
		final InputStream is = this.getClass().getClassLoader().getResourceAsStream("resources/beethoven.obj");
		if (is == null) {
			return new HE_Mesh();
		}
		...
		HE_Mesh result = new HE_Mesh(creator);
		HE_Selection faces = result.selectAllBoundaryFaces();
		result.delete(faces);
		return result;
	}
