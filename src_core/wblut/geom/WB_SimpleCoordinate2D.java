 ...
 *
 */
public class WB_SimpleCoordinate2D implements WB_Coord {
	/** Coordinates. */
	double x, y;
	 ...
	 * @param y
	 */
	public WB_SimpleCoordinate2D(final double x, final double y) {
		this.x = x;
		this.y = y;
	}
	 ...
	 * @param x
	 */
	public WB_SimpleCoordinate2D(final double[] x) {
		if (x.length != 2) {
