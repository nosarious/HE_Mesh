 ...
 *
 */
public class WB_SimpleCoordinate4D extends WB_SimpleCoordinate {
	/** Coordinates. */
	double w;
	 ...
	 * @param y
	 */
	public WB_SimpleCoordinate4D(final double x, final double y) {
		this.x = x;
		this.y = y;
		z = 0;
		w = 0;
	 ...
	 * @param z
	 */
	public WB_SimpleCoordinate4D(final double x, final double y, final double z) {
		this.x = x;
		this.y = y;
		this.z = z;
		w = 0;
	 ...
	 * @param w
	 */
	public WB_SimpleCoordinate4D(final double x, final double y, final double z, final double w) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.w = w;
	 ...
	 * @param x
	 */
	public WB_SimpleCoordinate4D(final double[] x) {
		if (x.length != 4) {
